...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_SOLO_3V3_ENABLE]                           = ConfigMgr::GetBoolDefault("Solo.3v3.Enable", true);
    m_int_configs[CONFIG_SOLO_3V3_MIN_LEVEL]                         = ConfigMgr::GetIntDefault("Solo.3v3.MinLevel", 80);
