...
bool Pet::LoadPetFromDB(Player* owner, uint32 petentry, uint32 petnumber, bool current)
{
	...
	// Warlock pets should be on max hp and mana after dismount or summon, but not hunter pets, fixed by Natureknight
	...
	// Moved here for pets HP after dismount
	SynchronizeLevelWithOwner();
	return true;
}
			...
			case 27829: // Ebon Gargoyle
				{
					...
					//This should be commented until implementation of GCD for Gargoyle Strike:
