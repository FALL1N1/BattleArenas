    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            // ONLY SPELLS WITH SPELLFAMILY_GENERIC and EFFECT_SCHOOL_DAMAGE
                ...
                break;
            // LOS TEMP FIX FOR SOME SPELLS BY NATUREKNIGHT
			// Shadowfiend's Mana leech
			case 28305: 
			case 34650:
			// Grace trigger
			case 47930: 
			...
			case 15357:
			case 15359:
			// Divine Aegis trigger
			case 47753: 
			// Bloodlust
			case 2825:
			// Heroism
			case 32182:
		    // Mana Tide Totem trigger
			case 39609:
			// Bestial Wrath
			case 19574:
			// Wild Growth 
    ...
    for (uint32 i = 0; i < sSpellStore.GetNumRows(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
			...
			case 45524: // Chains of Ice
                 spellInfo->Effect[2] = 0; // show effect only on target
                 break;
            case 1543:  // Hunter's Flare 
                spellInfo->EffectRadiusIndex[0] = EFFECT_RADIUS_10_YARDS;
                spellInfo->EffectRadiusIndex[1] = EFFECT_RADIUS_10_YARDS; // 20 yards diameter
				spellInfo->speed = 100; // Faster launch
				 break;
            ...
            case 31344: // Howl of Azgalor
                spellInfo->EffectRadiusIndex[0] = EFFECT_RADIUS_100_YARDS; // 100 yards instead of 50000?!
                break;
			...
			case 52610: // Savage Roar
				...
				break;
			case 34490: // Fix animation effect bug for Silencing shot by Natureknight
           ...
           spellInfo->speed = 50;
            ...
            case 59725: // Improved Spell Reflection - aoe aura
				...
				// Improved Spell Reflection should be within 20 yards
            ...
            case 58655: // Flametongue Totem rank 8 (Aura)
                ...
                break;
			case 49575: // Fix Death Grip speed by Natureknight
