...
{	
   ...
   else if (x > 1276 && x < 1295 && y > 1661 && y < 1674 && z < 34) // Big Radius Graveyard at the middle by Natureknight
	 {
			return true;
	 }
	else if (x > 1279 && x < 1292 && y > 1664 && y < 1670 && z < 36) // Smaller Radius Graveyard at the middle by Natureknight
	 {
			return true;
	 }
   else	
