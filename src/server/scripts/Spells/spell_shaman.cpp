...
class spell_sha_bloodlust : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_bloodlust_SpellScript : public SpellScript
        {
			...
			{
				// Prevent casting Bloodlust when Sated is applied
				if (GetCaster()->HasAura(SHAMAN_SPELL_SATED))
            ...
            void Register()
            {
				OnCheckCast += SpellCheckCastFn(spell_sha_bloodlust_SpellScript::CheckCast);
...
class spell_sha_heroism : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_heroism_SpellScript : public SpellScript
        {
			...
			SpellCastResult CheckCast()
			{
				// Prevent casting Heroism when Exhaustion is applied
				if (GetCaster()->HasAura(SHAMAN_SPELL_EXHAUSTION))
					return SPELL_FAILED_CASTER_AURASTATE;
				return SPELL_CAST_OK;
			}
