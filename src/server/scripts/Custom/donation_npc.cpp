...
class Donation_NPC_AT : public CreatureScript
{
	public:
		...
		bool OnGossipHello(Player * pPlayer, Creature * pCreature)
		{
			...
			if (pPlayer->GetSession()->GetSecurity() < 5 && dp > 50)
			{
				pPlayer->GetSession()->SendAreaTriggerMessage("You have large amount of Donation points: %u. This is probably a website related problem, please immediately contact the administrator via ticket about this issue.", dp);
				pPlayer->CLOSE_GOSSIP_MENU();
				return false;
			...
			if (dp < 7) // VIP only for current char
			...
			{
			    if (dp < 5) // VIP only for current char
			...
			pPlayer->ADD_GOSSIP_ITEM(4, "Show my available Donation Points", GOSSIP_SENDER_MAIN, 999);
		...
		bool OnGossipSelect(Player * pPlayer, Creature * pCreature, uint32 sender, uint32 uiAction)
		{
			...
			case 9: // Conqueror
                if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(47)))
			    {
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Conqueror title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(47));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 10: // Justicar
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(48)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
					pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Justicar title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(48));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 11: // Battlemaster
                if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(72)))
			    {
				    pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
			    }
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Battlemaster title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(72));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 12: // Scarab Lord
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(46)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Scarab Lord title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(46));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 13: // Brewmaster
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(133)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Brewmaster title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(133));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 14: // the Love Fool
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(135)))
			    {
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned The Love Fool title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(135));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 15: // Matron
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(137)))
			    {
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
			    }
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Matron title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(137));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 16: // Patron
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(138)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
			    }
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Patron title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(138));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 17: // The Hallowed
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(124)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned The Hallowed title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(124));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 18: // Merrymaker
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(134)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
			    }
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Merrymaker title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(134));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 19: // The Noble
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(155)))
				{
				    pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned The Noble title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(155));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 20: // The Pilgrim
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(168)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned The Pilgrim title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(168));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 21: // Flame Keeper
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(76)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
			    }
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Flame Keeper title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(76));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 22: // Flame Warden
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(75)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Flame Warden title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(75));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 23: // Elder
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(74)))
				{
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
			    }
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Elder title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(74));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
			...
			case 24: // Jenkins
				if (pPlayer->HasTitle(sCharTitlesStore.LookupEntry(143)))
			    {
					pPlayer->GetSession()->SendAreaTriggerMessage("You already have this title.");
                    pPlayer->CLOSE_GOSSIP_MENU();
				}
                ...
                {
                    LoginDatabase.PExecute("UPDATE fusioncms_new.account_data SET dp = '%u' -1 WHERE id = '%u'", dp, pPlayer->GetSession()->GetAccountId());
                    pPlayer->GetSession()->SendAreaTriggerMessage("Successfully earned Jenkins title! Thanks for the support!");
                    pPlayer->SetTitle(sCharTitlesStore.LookupEntry(143));
                    pPlayer->SaveToDB();
                    pPlayer->CLOSE_GOSSIP_MENU();
                }
