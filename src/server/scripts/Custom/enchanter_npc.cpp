        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            switch (action)
            {
				...
				case 9: //Enchant Gloves
					...
					player->ADD_GOSSIP_ITEM(1, "+15 Agility", GOSSIP_SENDER_MAIN, 181);
				...
				/*	player->ADD_GOSSIP_ITEM(1, "35 Agility + 72 Stamina (LW)", GOSSIP_SENDER_MAIN, 189);
					player->ADD_GOSSIP_ITEM(1, "100 Attack Power + 36 Rating ", GOSSIP_SENDER_MAIN, 190); */
					player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				...
				case 11: //Enchant feet
					...
					//player->ADD_GOSSIP_ITEM(1, "Run Speed Increase for 5 Seconds (Eng)", GOSSIP_SENDER_MAIN, 198);
					player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
