...
public:
    ...
    struct npc_mirror_imageAI : CasterAI
    {
        ...
        void InitializeAI()
        {
			...
			// Mirror images should not attack targets with CC aura
...
public:
    ...
    struct npc_ebon_gargoyleAI : CasterAI
    {
        ...
        void InitializeAI()
        {
			...
			// Gargoyle should be immune to fear and horror mechanics by Natureknight:
			owner = me->GetOwner();
        ...
        void SpellHit(Unit* source, SpellInfo const* spell)
        {
			...
			despawnTimer = 2 * IN_MILLISECONDS;
        }
